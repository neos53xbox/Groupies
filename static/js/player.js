...
(function ($) {
    ...
    var _ = {
        ...
        init: function (options) {
            ...
            var template = ['<svg viewBox="0 0 100 100" id="playable" version="1.1" xmlns="http://www.w3.org/2000/svg" width="300" height="300" data-play="playable" class="not-started playable">',
                '<g class="shape">',
                ...
                '<circle class="progress-bar" cx="50" cy="50" r="47.45" stroke="#B79E41" stroke-opacity="1" stroke-linecap="round" fill="none" stroke-width="5" transform="rotate(-90 50 50)"/>',
                '</g>',
                ...
                '<polygon points="45,35 65,50 45,65" fill="#dbb939" stroke-width="0"></polygon>',
                '</g>',
                '<g class="control stop">',
                '<rect x="35" y="35" width="30" height="30" stroke="#faf9f7" fill="none" stroke-width="1"/>',
                '</g>',
                '</svg>'];
